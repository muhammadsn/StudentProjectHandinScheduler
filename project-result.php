...
if (isset($_REQUEST['id'])){
    if ($project->fetch_project_info($_REQUEST['id'])) {
        if ($student->has_project($_REQUEST['id'])) {
            $times = $student->fetch_project_sched_info_confirmed($_REQUEST['id']);
        }
        else{
...
<div class="box_teacher_form_1 col-lg-10 col-xl-10 col-md-10 col-sm-12 offset-lg-1 offset-xl-1 offset-md-1" id="main_box">
    <div class="box_title_teacher_form_1">
        <h3 class="panel_title">زمان تحویل پروژه شما</h3>
    ...
    <div class="box_content">
        ...
        <div class="form_wrap_tf2">
            ...
            <div class="panel_item_title panel_item_title_1" id="form_item_1">
                <span class="form_desc form_desc_id" for="sid">زمانی که برای شما جهت تحویل این پروژه در نظر گرفته شده است</span>
            </div>
        ...
        <?php if ($times && isset($_REQUEST['id']) && $has_access): ?>
            <div class="project-info">
